...
# self.ui.EstDepth.setText(verdien-som-skal-vises)
#
## Husk også å legge til kamera feed som dere gjorde sist.
...
class ControlMainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ui.EstPosBtn.clicked.connect(lambda : self.ui.WidgetPages.setCurrentIndex(4))
